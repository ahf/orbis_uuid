...
%%% @doc The Primary Supervisor for the Orbis UUID Application
%%% @end
%%% ----------------------------------------------------------------------------
-module(orbis_uuid_sup).
...
%% @private
init([]) ->
    PoolSize = application:get_env(orbis_uuid, pool_size, 8),
    Procs = orbis:child_spec(orbis_uuid_pool, PoolSize, orbis_uuid_worker),
